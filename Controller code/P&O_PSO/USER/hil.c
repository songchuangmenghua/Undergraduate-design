...
//	for(i=0;dec!=0;i++)
//	{
//		if(dec%16==10)buffer[i]='A';
//		else if(dec%16==11)buffer[i]='B';
//		else if(dec%16==12)buffer[i]='C';
//		else if(dec%16==13)buffer[i]='D';
//		else if(dec%16==14)buffer[i]='E';
//		else if(dec%16==15)buffer[i]='F';
//		else buffer[i]=(dec%16)+'0';
//		dec=dec/16;
//	}
//	return(buffer);
//}
